		...
		<div className="flex flex-col gap-8 border-2 border-orange-800 p-8">
			...
			<div className="flex flex-col items-stretch gap-4">
				{question.options.map((option: DictionaryEntry) => (
					<button
						className="flex min-w-48 items-center justify-center border-2 border-orange-800 bg-neutral-900 p-2 text-2xl text-orange-100 hover:border-orange-700 hover:text-orange-700"
						key={option.id}
						type="button"
